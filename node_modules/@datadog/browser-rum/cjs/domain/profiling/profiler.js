...
function createRumProfiler(configuration, lifeCycle, session, profilingContextManager, profilerConfiguration = exports.DEFAULT_RUM_PROFILER_CONFIGURATION) {
    ...
    function handleProfilerTrace(trace) {
        ...
        transport_1.transport.sendProfile(trace, configuration, sessionId).catch(browser_core_1.monitorError);
    }
