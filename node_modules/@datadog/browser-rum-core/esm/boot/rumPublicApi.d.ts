import type { Context, DeflateWorker, DeflateEncoderStreamId, DeflateEncoder, PublicApi, ContextManager, TrackingConsent, User, Account, RumInternalContext, Telemetry } from '@datadog/browser-core';
...
import type { AddDurationVitalOptions, DurationVitalOptions, DurationVitalReference } from '../domain/vital/vitalCollection';
...
export interface ProfilerApi {
    stop: () => void;
    onRumStart: (lifeCycle: LifeCycle, hooks: Hooks, configuration: RumConfiguration, sessionManager: RumSessionManager, viewHistory: ViewHistory) => void;
}
