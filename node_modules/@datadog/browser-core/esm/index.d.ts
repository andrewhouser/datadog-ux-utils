...
export { startTelemetry, addTelemetryDebug, addTelemetryError, resetTelemetry, TelemetryService, isTelemetryReplicationAllowed, addTelemetryConfiguration, addTelemetryUsage, addTelemetryMetrics, } from './domain/telemetry';
